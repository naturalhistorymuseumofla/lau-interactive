require([
     ...
     */
      ...
      esriConfig.apiKey = "AAPK1322a5a204a145f992aead082b199a80gh6YxgkpwAsAPEuvQ6WEq7MqqTP4MyCWShNiLG99f2Xz41GNx31zExD4SYeajGQv";
      ...
      const areasFeatureLayer = new FeatureLayer({
          url: 'https://services7.arcgis.com/zT20oMv4ojQGbhWr/arcgis/rest/services/a1dd69/FeatureServer'
      })
      ...
      searchWidget.viewModel.on('search-complete', function(event){
        ...
        areasFeatureLayer.queryFeatures(query).then((r)=>{
            console.log(r);
        }).catch((error)=>{
            console.log(error);
        })
